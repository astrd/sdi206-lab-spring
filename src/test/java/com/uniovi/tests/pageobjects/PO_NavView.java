...
public class PO_NavView extends PO_View {
	 ...
	 *        destino.
	 */
	public static void clickOption(WebServer driver, String textOption, String criterio, String textoDestino) {
		// CLickamos en la opción de registro y esperamos a que se cargue el enlace de

		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina((WebDriver) driver, "@href", textOption,
				getTimeout());
		...
		elementos = SeleniumUtils.EsperaCargaPagina((WebDriver) driver, criterio, textoDestino, getTimeout());
		// Tiene que haber un sólo elemento.
		assertTrue(elementos.size() == 1);
	}
